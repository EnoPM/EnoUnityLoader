...
public sealed class BetterRoleAssignments
{
    ...
    private void SetTeamPreference(int playerId, TeamPreferences preference)
    {
    ...
    private void SetForcedAssignment(int playerId, TeamPreferences preference)
    {
    ...
    private Dictionary<byte, int> CalculateWeights(RoleTeamTypes team, bool ignorePlayerPreferences = false)
    {
        ...
        foreach (var player in _remainingPlayers)
        {
            ...
            {
                weight = forcedAssignment == oppositeTeamPreference ? 0 : // Si l'assignation forcée est pour l'équipe opposée, ce joueur ne sera pas choisi pour cette équipe
    ...
    private void DebugPreferences()
    {
        ...
        foreach (var preference in _playerPreferences)
        {
            ...
            var playerName = player != null ? player.Player.Data.PlayerName : "???";
