...
{
    /// <summary>
    ///     Set of source names that should not be logged to disk.
    /// </summary>
    public static HashSet<string> BlacklistedSources { get; } = [];
                           ...
                           int fileLimit = 5)
    {
        ...
        while (!Utility.TryOpenFileStream(Path.Combine(Paths.ModLoaderRootPath, localPath),
