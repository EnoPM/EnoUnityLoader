...
public class ManualLogSource : ILogSource
{
    ...
    /// </summary>
    /// <param name="logHandler">Handler for the interpolated string.</param>
    public void LogFatal(ModLoaderFatalLogInterpolatedStringHandler logHandler) => Log(LogLevel.Fatal, logHandler);
    ...
    /// </summary>
    /// <param name="logHandler">Handler for the interpolated string.</param>
    public void LogError(ModLoaderErrorLogInterpolatedStringHandler logHandler) => Log(LogLevel.Error, logHandler);
    ...
    /// </summary>
    /// <param name="logHandler">Handler for the interpolated string.</param>
    public void LogWarning(ModLoaderWarningLogInterpolatedStringHandler logHandler) => Log(LogLevel.Warning, logHandler);
    ...
    /// </summary>
    /// <param name="logHandler">Handler for the interpolated string.</param>
    public void LogMessage(ModLoaderMessageLogInterpolatedStringHandler logHandler) => Log(LogLevel.Message, logHandler);
    ...
    /// </summary>
    /// <param name="logHandler">Handler for the interpolated string.</param>
    public void LogInfo(ModLoaderInfoLogInterpolatedStringHandler logHandler) => Log(LogLevel.Info, logHandler);
    ...
    /// </summary>
    /// <param name="logHandler">Handler for the interpolated string.</param>
    public void LogDebug(ModLoaderDebugLogInterpolatedStringHandler logHandler) => Log(LogLevel.Debug, logHandler);
}
