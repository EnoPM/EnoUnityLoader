...
{
    private static readonly Dictionary<Type, System.Func<object, Object>> boxers = [];

    private readonly IEnumerator enumerator = null!; // Initialized in managed constructor, not IntPtr constructor
