...
{
    /// <summary>
    /// Whether the detour is valid.
    /// </summary>
    bool IsValid { get; }

    /// <summary>
    /// Whether the detour is currently applied.
    /// </summary>
    bool IsApplied { get; }
    ...
    /// <summary>
    /// Undo the detour without freeing resources.
    /// </summary>
    void Undo();

    /// <summary>
    /// Free the detour resources.
    /// </summary>
    void Free();

    /// <summary>
    /// Generate a trampoline to call the original method.
    /// </summary>
    MethodBase? GenerateTrampoline(MethodBase? signature = null);

    /// <summary>
    /// Generate a typed trampoline delegate to call the original method.
    /// </summary>
    ...
    public static INativeDetour Create<T>(nint original, T target) where T : Delegate
    {
        ...
        // Always use cache wrapper on CoreCLR/.NET to prevent delegate collection
    ...
    private sealed class CacheDetourWrapper : INativeDetour
    {
