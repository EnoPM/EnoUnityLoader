...
{
    /// <summary>
    ///     Creates a patch definition targeting an assembly.
    /// </summary>
    ...
    /// <summary>
    ///     Creates a patch definition targeting a type.
    /// </summary>
...
public class PatcherContext
{
    ...
    /// <summary>
    ///     <para>Contains a mapping of assembly filename to its source type (Plugin or Interop).</para>
    /// </summary>
    public Dictionary<string, PatcherTarget> AssemblySources { get; } = new();
    ...
    ///     purposes. Defaults to ModLoader/DumpedAssemblies/&lt;ProcessName&gt;
    /// </summary>
    public string DumpedAssembliesPath { get; internal set; } = string.Empty;
}
