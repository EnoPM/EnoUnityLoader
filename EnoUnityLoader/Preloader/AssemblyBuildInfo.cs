...
{
    /// <summary>
    ///     The type of .NET framework the assembly targets.
    /// </summary>
    public enum FrameworkType
    {
        ...
        NetStandard,
        /// <summary>.NET Core / .NET 5+.</summary>
        NetCore
    }

    /// <summary>
    ///     The .NET Framework version the assembly targets.
    /// </summary>
    public Version NetFrameworkVersion { get; private set; } = new(0, 0);

    /// <summary>
    ///     Whether the assembly targets AnyCPU.
    /// </summary>
    public bool IsAnyCpu { get; set; }

    /// <summary>
    ///     Whether the assembly is 64-bit.
    /// </summary>
    public bool Is64Bit { get; set; }

    /// <summary>
    ///     The framework type the assembly targets.
    /// </summary>
    ...
    private void SetNet4Version(AssemblyDefinition assemblyDefinition)
    {
        ...
        foreach (var value in values)
        {
            ...
            else if (value.StartsWith("Version=v"))
            {
                try
                {
                    NetFrameworkVersion = new Version(value["Version=v".Length..]);
                }
                catch { }
            }
        }
    ...
    /// <summary>
    ///     Determines the build info of an assembly.
    /// </summary>
    /// <param name="assemblyDefinition">The assembly to analyze.</param>
