...
/// <summary>
/// Processor that marks unsupported members with HideFromIl2Cpp attribute.
/// </summary>
public sealed class UnsupportedIl2CppMemberProcessor : BaseMonoBehaviourProcessor
{
    ...
    public UnsupportedIl2CppMemberProcessor(MonoBehaviourContext context) : base(context)
    {
    ...
    private bool IsTypeSupportedInIl2Cpp(TypeReference type)
    {
        ...
        {
            Context.Logger.LogWarning($"Unresolved type: '{type.FullName}'. {ex.Message}");
            return false;
        }
