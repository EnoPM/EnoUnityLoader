...
/// <summary>
/// Processor that ensures MonoBehaviour types have an IntPtr constructor.
/// Required for IL2CPP object instantiation.
/// </summary>
public class IntPtrConstructorProcessor : BaseMonoBehaviourProcessor
{
    public IntPtrConstructorProcessor(MonoBehaviourContext context) : base(context)
    {
    }
    ...
    public override void Process()
    {
        ...
        {
            Context.Logger.LogDebug($"[{Context.ProcessingType.Name}] No default constructor found, creating a new one...");
            CreateIntPtrConstructor();
        }
        else
        {
            Context.Logger.LogDebug($"[{Context.ProcessingType.Name}] Default constructor found, updating it...");
    ...
    private void CreateIntPtrConstructor()
    {
        ...
        Context.Logger.LogDebug($"{Context.ProcessingType.Name} : {parentConstructorDefinition.FullName}");
